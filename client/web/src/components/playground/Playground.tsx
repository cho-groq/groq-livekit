...
const API_KEY_ENDPOINT = "https://groq-livekit-backend-417990686885.us-west1.run.app/api/set-api-key";
...
export default function Playground({ onConnect }: PlaygroundProps) {
 ...
 const handleApiKeySubmit = async (key: string) => {
  ...
  try {
    ...
    const pingResponse = await fetch("https://groq-livekit-backend-417990686885.us-west1.run.app/ping", {
      method: 'GET',
      headers: {
